...
\begin{frame}
  ...
  \begin{block}{}
    ...
    \begin{minipage}{0.80\textwidth}
      ...
      with Python and the packages scikit-learn and keras/tensoreflow.\\
...
\begin{frame}
  \begin{center}
    \frametitle{AI encompasses many methods}
...
% "Artificial neurons are the building blocks of all neural network
% models. An artificial neuron is simply a mathe- matical function
% that maps (converts) inputs to outputs in a specific way. A single
% artificial neuron takes in any num- ber of input values, applies a
% specific mathematical func- tion to them and returns an output
% value. The function used is usually represented as."
...
%% %%%%%%%%%%%%%%%%%%%
%% \subsection{Multilayer perceptrons / Feed-forward neural networks}
%% %%%%%%%%%%%%%%%%%%%
...
%%     \begin{center}
%%       \begin{itemize}
%%       \item fixed number of input nodes/features
%%       \item 
%%       \end{itemize}
%%     \end{center}
%%   \end{block}
...
%%     \begin{center}
%%       \begin{itemize}
%%       \item useful for image processing and pattern recognition tasks
%%       \item sparse network
%%       \end{itemize}
%%     \end{center}
%%   \end{block}
...
%%   \frametitle{Multilayer perceptrons}
%%   \begin{center}
%%     \includegraphics[width=13.0cm]{images/CNN.pdf}
%%   \end{center}  
%% \end{frame}
...
\begin{frame}
  ...
  \begin{block}{}
    \begin{center}
      ...
      \ \\
      \href{konrad.foerstner.org}{konrad.foerstner.org} / \href{https://mastodon.social/@kuf}{@kuf@mastodon.social} /  \href{https://twitter.com/konradfoerstner}{@konradfoerstner}\\
      \ \\
